...
TYWENGINE_API void RegisterEngineScriptEvents(void);


//---------------------------------------------------------------------------------------------------------------------
// EvtData_New_Actor - This event is sent out when an actor is *actually* created.
//---------------------------------------------------------------------------------------------------------------------
class TYWENGINE_API EvtData_New_Actor : public BaseEventData
{
...
//---------------------------------------------------------------------------------------------------------------------
class TYWENGINE_API EvtData_Destroy_Actor : public BaseEventData
{
	unsigned int m_id;
...
//---------------------------------------------------------------------------------------------------------------------
class TYWENGINE_API EvtData_Move_Actor : public BaseEventData
{
	unsigned int m_id;
	glx::mat4<float> m_matrix;
...
public:
	...
	EvtData_Move_Actor(unsigned int id, const glx::mat4<float>& matrix)
	...
	const glx::mat4<float>& GetMatrix(void) const
	{
		return m_matrix;
	}
};
...
//---------------------------------------------------------------------------------------------------------------------
class TYWENGINE_API EvtData_Modified_Render_Component : public BaseEventData
{
	unsigned int m_id;
...
//---------------------------------------------------------------------------------------------------------------------
class TYWENGINE_API EvtData_Environment_Loaded : public BaseEventData
{
public:
	static const EventType sk_EventType;
...
//---------------------------------------------------------------------------------------------------------------------
class TYWENGINE_API EvtData_Remote_Environment_Loaded : public BaseEventData
{
public:
	static const EventType sk_EventType;
...
//---------------------------------------------------------------------------------------------------------------------
class TYWENGINE_API EvtData_Request_Start_Game : public BaseEventData
{
...
//---------------------------------------------------------------------------------------------------------------------
class TYWENGINE_API EvtData_Remote_Client : public BaseEventData
{
	int m_socketId;
	int m_ipAddress;
...
//---------------------------------------------------------------------------------------------------------------------
class TYWENGINE_API EvtData_Update_Tick : public BaseEventData
{
...
//---------------------------------------------------------------------------------------------------------------------
class TYWENGINE_API EvtData_Network_Player_Actor_Assignment : public BaseEventData
{
	unsigned int m_ActorId;
	int m_SocketId;
...
//---------------------------------------------------------------------------------------------------------------------
class TYWENGINE_API EvtData_Decompress_Request : public BaseEventData
{
...
//---------------------------------------------------------------------------------------------------------------------
class TYWENGINE_API EvtData_Decompression_Progress : public BaseEventData
{
	int m_progress;
	std::wstring m_zipFileName;
	std::string m_fileName;
...
//---------------------------------------------------------------------------------------------------------------------
class TYWENGINE_API EvtData_Request_New_Actor : public BaseEventData
{
	std::string m_actorResource;
	bool m_hasInitialTransform;
	glx::mat4<float> m_initialTransform;
...
public:
	...
	EvtData_Request_New_Actor()
	{
		...
		GLXMatrixIdentity(&m_initialTransform);
		m_serverActorId = -1;
		m_viewId = 0;
	}

	explicit EvtData_Request_New_Actor(const std::string &actorResource, const glx::mat4<float> *initialTransform = NULL, const unsigned int serverActorId = 0, const unsigned int viewId = 0)
	{
	...
	const glx::mat4<float> *GetInitialTransform(void) const { return (m_hasInitialTransform) ? &m_initialTransform : NULL; }
...
//---------------------------------------------------------------------------------------------------------------------
class TYWENGINE_API EvtData_Request_Destroy_Actor : public ScriptEvent
{
	unsigned int m_actorId;
...
public:
	...
	EvtData_Request_Destroy_Actor(unsigned int actorId)
	{
		m_actorId = actorId;
	}
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(TYW_NEW EvtData_Request_Destroy_Actor(m_actorId));
	}
...
//---------------------------------------------------------------------------------------------------------------------
class TYWENGINE_API EvtData_PlaySound : public ScriptEvent
{
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(TYW_NEW EvtData_PlaySound(m_soundResource));
	}
...
namespace Event
{
	...
	TYWENGINE_API inline const EventType Get_EvtData_Environment_Loaded()
	{
		return EvtData_Environment_Loaded::sk_EventType;
	}

	TYWENGINE_API inline const EventType Get_EvtData_Remote_Environment_Loaded()
	{
		return EvtData_Remote_Environment_Loaded::sk_EventType;
	}


	TYWENGINE_API inline const EventType& Get_EvtData_New_Actor()
	{
		return EvtData_New_Actor::sk_EventType;
	}

	TYWENGINE_API inline const EventType Get_EvtData_Move_Actor()
	{
		return EvtData_Move_Actor::sk_EventType;
	}


	TYWENGINE_API inline const EventType Get_EvtData_Destroy_Actor()
	{
		return EvtData_Destroy_Actor::sk_EventType;
	}

	TYWENGINE_API inline const EventType Get_EvtData_New_Render_Component()
	{
		return EvtData_New_Render_Component::sk_EventType;
	}


	TYWENGINE_API inline const EventType Get_EvtData_Modified_Render_Component()
	{
		return EvtData_Modified_Render_Component::sk_EventType;
	}

	TYWENGINE_API inline const EventType Get_EvtData_Request_Start_Game()
	{
		return EvtData_Request_Start_Game::sk_EventType;
	}

	TYWENGINE_API inline const EventType Get_EvtData_Remote_Client()
	{
		return EvtData_Remote_Client::sk_EventType;
	}

	TYWENGINE_API inline const EventType Get_EvtData_Update_Tick()
	{
		return EvtData_Update_Tick::sk_EventType;
	}

	TYWENGINE_API inline const EventType Get_EvtData_Decompress_Request()
	{
		return EvtData_Decompress_Request::sk_EventType;
	}

	TYWENGINE_API inline const EventType Get_EvtData_Decompression_Progress()
	{
		return EvtData_Decompression_Progress::sk_EventType;
	}

	TYWENGINE_API inline const EventType Get_EvtData_Request_New_Actor()
	{
		return EvtData_Request_New_Actor::sk_EventType;
	}

	TYWENGINE_API inline const EventType Get_EvtData_Request_Destroy_Acto()
	{
		return EvtData_Request_Destroy_Actor::sk_EventType;
	}

	TYWENGINE_API inline const EventType Get_EvtData_PlaySound()
	{
		return EvtData_PlaySound::sk_EventType;
	}
}
