...
//---------------------------------------------------------------------------------------------------------------------
 sol::object ScriptEvent::GetEventData(void)
{
...
//---------------------------------------------------------------------------------------------------------------------
bool ScriptEvent::SetEventData(sol::object eventData)
{
    //m_eventData.set_lua = eventData.lua_state;
...
//	m_eventData;
//	sol::object eventTypeTable = LuaStateManager::Get()->GetGlobalVars().GetByName("EventType");
//	if (eventTypeTable.i)
//	{
