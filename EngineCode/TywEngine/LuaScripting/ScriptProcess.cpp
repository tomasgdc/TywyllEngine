...
{
	//sol::state* pLuaState = LuaStateManager::Get()->GetLuaState();
...
bool ScriptProcess::BuildCppDataFromScript(sol::object scriptClass, sol::object constructionData)
{
	/*
...
void ScriptProcess::ScriptAttachChild(sol::object child)
{
	/*
	if (child.IsTable())
	{
...
sol::object ScriptProcess::CreateFromScript(sol::object self, sol::object constructionData, sol::object originalSubClass)
{
	...
	ScriptProcess* pObj =  TYW_NEW ScriptProcess;
...
void ScriptProcess::RegisterScriptClassFunctions(sol::object& metaTableObj)
{
	/*
